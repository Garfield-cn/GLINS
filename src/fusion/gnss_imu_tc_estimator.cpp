...
**/
#include "gici/fusion/gnss_imu_tc_estimator.h"
...
GnssImuTcEstimator::GnssImuTcEstimator(
                     const GnssImuTcEstimatorOptions& options, 
...
bool GnssImuTcEstimator::addGnssMeasurementAndState(const GnssSolution& gnss_solution)
{
  // Wait for IMU data
...
// Add IMU measurement
void GnssImuTcEstimator::addIMUMeasurement(const ImuMeasurement& imu_measurement)
{
...
void GnssImuTcEstimator::optimize()
{
...
// Get pose
Transformation GnssImuTcEstimator::getPoseEstimate()
{
...
Transformation GnssImuTcEstimator::getPoseIntegrated()
{
...
// Get speed and bias
SpeedAndBias GnssImuTcEstimator::getSpeedAndBias()
{
  State& state = lastState();
...
Eigen::Vector3d GnssImuTcEstimator::getGnssExtrinsic()
{
  State& state = lastState();
...
// Marginalization
bool GnssImuTcEstimator::marginalization()
{
