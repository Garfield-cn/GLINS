...
// Global point-to-plane registration error
// Parameter block: body pose in ENU (7)
class GlobalRegistrationError
  : public ceres::SizedCostFunction<1 /* number of residuals */, 7 /* parameter blocks */>,
...
public:
  ...
  GlobalRegistrationError(const Eigen::Vector4d& params, const Point_lidar p,
                          const Eigen::Matrix<double, 1, 1>& information);

  /// \brief Trivial destructor.
  virtual ~GlobalRegistrationError()
  {}
