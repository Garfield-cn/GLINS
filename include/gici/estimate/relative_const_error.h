/**
* @Function: Constant relative state error
*
* @Author  : Cheng Chi
...
public:
  ...
  typedef ceres::SizedCostFunction<Dim, Dim, Dim> base_t;
  ...
  RelativeConstError(const Eigen::Matrix<double, Dim, Dim>& information) {
