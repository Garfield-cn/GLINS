...
// Group 1: P1. receiver position in parameter frame (3)
...
public:
  ...
  /// @param[in] position_measurement The position measurement.
  /// @param[in] information The information.
  PositionError(const Eigen::Vector3d& position_measurement,
  ...
  void setMeasurement(const Eigen::Vector3d& position_measurement)
  {
    measurement_ = position_measurement;
  }
...
template class PositionError<3>;  // Group 1
template class PositionError<7, 3>;  // Group 2
