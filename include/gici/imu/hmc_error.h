...
/// \brief Heading measurement constraint error.
class HMCError :
...
public:
  ...
  /// @param[in] std STD of heading constraint.
  HMCError(const double std);

  /// \brief Trivial destructor.
  virtual ~HMCError() = default;
